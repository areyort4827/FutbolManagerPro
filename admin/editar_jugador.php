...
// ── EQUIPOS (todos los del sistema para admin) ──────────────────────────────
$equipos = $pdo->query("
    SELECT e.id, e.nombre, e.categoria, c.nombre AS club_nombre
    FROM equipos e
    JOIN clubes c ON e.equipo_id = c.id
            ...
            <select name="equipo_id" required>
                ...
                <?php foreach ($equipos as $eq): ?>
                    <option value="<?= $eq['id'] ?>" 
                        ...
                        <?= htmlspecialchars($eq['club_nombre']) ?> — <?= htmlspecialchars($eq['nombre']) ?> (<?= htmlspecialchars($eq['categoria']) ?>)
                    </option>
                <?php endforeach; ?>
            </select>
