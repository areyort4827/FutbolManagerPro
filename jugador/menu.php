...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="menu">
            ...
            <a class="<?= $paginaActual === 'entrenamientos'  ? 'active' : '' ?>"
                onclick="mostrarPagina('entrenamientos')">
            ...
            <a class="<?= $paginaActual === 'estadisticas'    ? 'active' : '' ?>"
                onclick="mostrarPagina('estadisticas')">
