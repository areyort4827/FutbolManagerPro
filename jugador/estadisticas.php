...
<body>
    <div class="container">
        ...
        <p class="subtitle">Análisis de tu rendimiento individual ·
            <?= htmlspecialchars($mi_jugador['nombre_equipo'] ?? '') ?></p>
            ...
            <div class="card">
                <div class="card-header">
                    <div>
                        ...
                        <div class="card-sub"><span class="amarilla"><i class="fas fa-square"></i>
                                <?= $amarillas ?></span>
        ...
        <div class="top-scorers">
            ...
            <div class="player">
                ...
                <div class="player-info">
                    ...
                    <div style="color:#6b7280;font-size:.9rem;"><?= (int)$g['total_asistencias'] ?> asistencias ·
                        <?= htmlspecialchars($g['posicion']) ?></div>
                </div>
                <div>
    ...
    new Chart(document.getElementById('rendimientoPersonalChart'), {
        ...
        data: {
            ...
            datasets: [{
                    label: 'Goles',
                    data: <?= json_encode($data_goles_mes) ?>,
                    backgroundColor: '#10b981'
                },
                {
                    label: 'Asistencias',
                    data: <?= json_encode($data_asist_mes) ?>,
