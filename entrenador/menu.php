...
<div class="sidebar">
    ...
    <div class="menu">
    <a class="page <?= $paginaActual === 'dashboard' ? 'active' : '' ?>" onclick="mostrarPagina('dashboard', this)">
        <i class="fa-solid fa-gauge"></i> Dashboard
    </a>
    <a class="page <?= $paginaActual === 'jugadores' ? 'active' : '' ?>" onclick="mostrarPagina('jugadores', this)">
        <i class="fa-solid fa-user"></i> Jugadores
    </a>
    <a class="page <?= $paginaActual === 'entrenamientos' ? 'active' : '' ?>" onclick="mostrarPagina('entrenamientos', this)">
        <i class="fa-solid fa-dumbbell"></i> Entrenamientos
    </a>
    <a class="page <?= $paginaActual === 'partidos' ? 'active' : '' ?>" onclick="mostrarPagina('partidos', this)">
        <i class="fa-solid fa-futbol"></i> Partidos
    </a>
    <a class="page <?= $paginaActual === 'estadisticas' ? 'active' : '' ?>" onclick="mostrarPagina('estadisticas', this)">
        <i class="fa-solid fa-chart-line"></i> Estadísticas
    </a>
    <a class="page <?= $paginaActual === 'calendario' ? 'active' : '' ?>" onclick="mostrarPagina('calendario', this)">
